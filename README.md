...
- Click (o entrada polar) para fijar puntos; historial temporal (últimos 3, fade 3 s) y botón **Historial** de sesión
...
Los puntos fijados aparecen en la esquina superior y se desvanecen en unos 3 segundos (máximo 3 visibles a la vez). Quedan guardados en el historial de la sesión hasta cerrar la vista o limpiarlo.
